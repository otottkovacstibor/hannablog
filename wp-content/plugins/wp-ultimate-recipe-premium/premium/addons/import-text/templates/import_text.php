        ...
        <tr>
            <td>
                <ul id="regions-buttons">
                    <li><button id="region-title" class="regions-button"><?php _e( 'Title', 'wp-ultimate-recipe' );?></button></li>
                    <li><button id="region-description" class="regions-button"><?php _e( 'Description', 'wp-ultimate-recipe' );?></button></li>
                    <li><button id="region-ingredients" class="regions-button"><?php _e( 'Ingredients', 'wp-ultimate-recipe' );?></button></li>
                    <li><button id="region-instructions" class="regions-button"><?php _e( 'Instructions', 'wp-ultimate-recipe' );?></button></li>
                    <li><button id="region-notes" class="regions-button"><?php _e( 'Notes', 'wp-ultimate-recipe' );?></button></li>
                </ul>
            </td>
            <td>
