<div class="wrap wpurp-import">
    ...
    <ol>
        ...
        <li>
            If you have the Recipe Image field set in your RecipeCard plugin it will replace the featured image of the post.
        </li>
        <li>
    ...
    <form method="POST" action="<?php echo admin_url( 'edit.php?post_type=recipe&page=wpurp_import_recipecard_manual' ); ?>">
        ...
        <?php submit_button( __( 'Import RecipeCard', 'wp-ultimate-recipe' ) ); ?>
    </form>

<?php
$recipecard_recipes = $this->get_recipecard_recipes();

if( count( $recipecard_recipes['problem'] ) != 0 ) {
?>
    ...
    <?php
    foreach( $recipecard_recipes['problem'] as $post_id => $recipecard_id ) {
