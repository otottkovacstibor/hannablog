        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.$watch('template.blocks['+attrs.id+']', function() {
                    ...
                    // Icon
                    var iconName        = scope.getPropVal(attrs.id, 'iconName')
                    ...
                    // Custom Field Key
                    var recipeCustomFieldKey = scope.getPropVal(attrs.id, 'recipeCustomFieldKey')
                    ...
                    // Custom Field Key
                    if(recipeCustomFieldKey) {
                        text = recipeCustomFieldKey + ' (Custom Field)'
                        tag = 'span'
                    }
        ...
        return {
            ...
            link: function(scope, element, attrs, ngModel) {
                scope.openImageManager = function() {
                    window.wpurp_image_manager = function(url, width, height) {
                    ...
                    window.open('../../../../../../../wp-admin/edit.php?post_type=recipe&page=wpurp_image_manager');
                }
            },
            replace: true
        };
