...
//                var_dump( $external_deps );
            ...
            wp_enqueue_script( 'wpurp_script_minified', WPUltimateRecipe::get()->coreUrl . '/assets/wpurp-public.min.js', $external_deps, WPURP_VERSION, true );
    ...
    private function minify( $assets, $dir )
    {
        ...
        array_unshift( $css_to_minify, WPUltimateRecipe::get()->coreDir . '/css/layout_base.min.css' );
        $minify_files[] = array(
        ...
        $css_to_minify[0] = WPUltimateRecipe::get()->coreDir . '/css/layout_base_forced.min.css';
        $minify_files[] = array(
