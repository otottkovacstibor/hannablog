...
class WPRM_SC_Pin extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		$pin_url = 'http://www.pinterest.com/pin/create/bookmarklet/';
		...
		$output = '<a href="' . $pin_url . '" ' . $pin_script .' style="' . $style . '" class="' . implode( ' ', $classes ) . '" target="_blank" rel="nofollow">' . $icon . $atts['text'] . '</a>';
