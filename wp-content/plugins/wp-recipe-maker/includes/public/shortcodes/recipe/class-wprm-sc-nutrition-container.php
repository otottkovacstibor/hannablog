...
class WPRM_SC_Nutrition_Container extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		$label = '';
		if ( $atts['label'] ) {
			$label = '<span class="wprm-recipe-details-label wprm-block-text-' . $atts['label_style'] . ' wprm-recipe-nutrition-label wprm-recipe-' . $atts['field'] . '-label">' . $atts['label'] . $atts['label_separator'] . '</span>';
		}
